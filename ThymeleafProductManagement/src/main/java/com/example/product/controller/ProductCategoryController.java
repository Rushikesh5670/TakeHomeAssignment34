...
public class ProductCategoryController {
	...
	public String searchByCategory(@RequestParam("category_id") Integer category_id, Model model) {
		List<Product> productList = productService.findByCategoryId(category_id);
